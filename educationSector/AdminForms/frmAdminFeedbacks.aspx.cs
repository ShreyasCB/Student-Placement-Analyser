...
{
    public partial class frmAdminFeedbacks : System.Web.UI.Page
    {
        ...
        public void GetAllQuestions()
        {
            ...
            if (tab.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < tab.Rows.Count; i++)
                {
                    ...
                    cell_replydate.Text = tab.Rows[i]["ResponseDate"].ToString();
            ...
            else
            {
                ...
                cell1.ColumnSpan = 5;
                cell1.Text = "No Student Feedbacks Found";
        ...
        public void GetPendingQuestions()
        {
            ...
            if (tab.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < tab.Rows.Count; i++)
                {
                    ...
                    btn_FQreply.ID = tab.Rows[i]["FeedbackId"].ToString();
        ...
        void btn_FQreply_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(string.Format("frmAdminReplyFeedbacks.aspx?value={0}", Question_ID));
        }
