...
<asp:Panel ID="panelLogin" runat="server">
   ...
   <TABLE id="Table1" cellSpacing="0" cellPadding="0" width="920px" border="0">
				<TR>
							...
							<TR>
								<TD vAlign="middle" align="left">
                                    <table id="Table3" border="0" cellpadding="1" cellspacing="1" 
                                        ...
                                        width="277">
                                        <tr>
                                            <td style="border-style: 1; border-color: #666666; border-width: 1px; FONT-WEIGHT: bold; FONT-SIZE: 12px; COLOR: white; FONT-FAMILY: Verdana; HEIGHT: 6px; BACKGROUND-COLOR: #FF9933">
                                                Choose Login Type :</td>
                                            <td style="border-style: 1; border-color: #666666; border-width: 1px; FONT-WEIGHT: bold; FONT-SIZE: 12px; COLOR: white; FONT-FAMILY: Verdana; HEIGHT: 6px; BACKGROUND-COLOR: #FF9933">
                                                &nbsp;</td>
                                            <td style="border-style: 1; border-color: #666666; border-width: 1px; FONT-WEIGHT: bold; FONT-SIZE: 12px; COLOR: white; FONT-FAMILY: Verdana; HEIGHT: 6px; BACKGROUND-COLOR: #FF9933">
                                                &nbsp;</td>
                                        ...
                                        <tr>
                                            <td style="BORDER-RIGHT: #669900 1px solid; BORDER-TOP: #669900 1px solid; BORDER-LEFT: #669900 1px solid; BORDER-BOTTOM: #99cc00 3px groove; HEIGHT: 116px; border-color: #FF9900 #FF9900 #CC9900 #FF9900;" 
                                                valign="top">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center" valign="middle">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                                ControlToValidate="Txt_User" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                            ...
                                            <td style="BORDER-RIGHT: #669900 1px solid; BORDER-TOP: #669900 1px solid; BORDER-LEFT: #669900 1px solid; BORDER-BOTTOM: #99cc00 3px groove; HEIGHT: 116px; border-color: #FF9900 #FF9900 #CC9900 #FF9900;" 
                                                ...
                                                <asp:Image ID="Image1" runat="server" Height="200px" 
                                                    ImageUrl="~/images/Index4.jpg" Width="380px" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="middle">
