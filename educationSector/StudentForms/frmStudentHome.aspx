<%@ Page Title="" Language="C#" MasterPageFile="~/StudentForms/StudentMasterpage.Master" AutoEventWireup="true" CodeBehind="frmStudentHome.aspx.cs" Inherits="educationSector.frmStudentHome" %>
							...
							<TR>
								...
								<TD style="FONT-WEIGHT: bold; FONT-SIZE: 12px; WIDTH: 109px; COLOR: white; FONT-FAMILY: Verdana; HEIGHT: 17px; BACKGROUND-COLOR: #006699"
									align="left"><strong class=" ">
                                        <asp:Label ID="Label3" runat="server" Width="150px">Student Attributes</asp:Label>
                                    </strong></TD>
							</TR>
							<TR>
									    ...
									    <tr>
                                            ...
                                            <td align="left" class="style4">
                                                <asp:Button ID="btnCheck" runat="server" Height="50px" onclick="btnCheck_Click" 
                                                    Text="Placement Prediction (NB)" ValidationGroup="attributes" Width="200px" />
                                                &nbsp;&nbsp;&nbsp;</td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
